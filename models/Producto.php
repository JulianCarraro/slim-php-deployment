...
Class Producto
{
    ...
    public function CrearProducto()
    {
        ...
        $consulta = $objAcessoDatos->PrepararConsulta("INSERT INTO productos (nombre, precio, sector, codigoDePedido, estadoDelProducto, tiempoEstimado, fechaAlta, fechaModificacion, activo) 
    ...
    {
        $objAcessoDatos = AccesoDatos::ObtenerInstancia();
        $consulta = $objAcessoDatos->PrepararConsulta("SELECT * FROM productos WHERE estadoDelProducto = :estadoDelProducto AND sector = :sector");
