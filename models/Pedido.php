...
Class Pedido
{
    ...
    public function GuardarImagenPedido($ruta, $urlImagen, $codigoDeMesa, $codigoDePedido, $nombreCliente)
    {
        $destino = $ruta . $codigoDeMesa . $codigoDePedido . $nombreCliente . ".jpg";  
